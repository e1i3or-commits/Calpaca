...
export const openApiOperations: readonly Operation[] = [
  ...
  ["get", "/signup-sheets/{publicId}", "Sign-up sheets", "Get a public sign-up sheet"],
  ["post", "/signup-sheets/{publicId}/registrations", "Sign-up sheets", "Register for one or more sessions"],
  ["post", "/signup-registrations/cancel", "Sign-up sheets", "Cancel a registration group"],
  ...
  ["get", "/api/me/proposals/{proposalId}", "Proposals", "Get a proposal", "session"],
  ["patch", "/api/me/proposals/{proposalId}", "Proposals", "Update a proposal draft", "session"],
  ["post", "/api/me/proposals/{proposalId}/{action}", "Proposals", "Advance or withdraw a proposal", "session"],
  ["post", "/api/me/availability-troubleshooter", "Schedules", "Diagnose why a time is unavailable", "session"],
  ...
  ["patch", "/api/me/workspace", "Workspace", "Update workspace name or public slug", "personal"],
  ["get", "/api/me/workspace/slug-available", "Workspace", "Check whether a public workspace slug is free", "personal"],
  ["get", "/api/me/onboarding", "Onboarding", "Get first-run setup progress", "personal"],
  ["patch", "/api/me/onboarding/step", "Onboarding", "Record the setup step reached", "personal"],
  ["post", "/api/me/onboarding/complete", "Onboarding", "Finish first-run setup", "personal"],
  ...
  ["get", "/api/me/engagements", "Engagements", "List visible client engagements", "session"],
  ["post", "/api/me/engagements", "Engagements", "Create a client engagement", "session"],
  ["get", "/api/me/engagements/clients/similar", "Engagements", "Find possible duplicate clients", "session"],
  ["get", "/api/me/engagements/{id}", "Engagements", "Get an engagement overview", "session"],
  ["patch", "/api/me/engagements/{id}/status", "Engagements", "Change an engagement lifecycle status", "session"],
  ["get", "/api/me/engagements/{engagementId}/conversations", "Conversations", "List an engagement's conversation playbooks", "session"],
  ["post", "/api/me/engagements/{engagementId}/conversations", "Conversations", "Create an engagement conversation playbook", "session"],
  ["get", "/api/me/engagements/{engagementId}/conversations/templates", "Conversations", "List reusable workspace playbooks", "session"],
  ["get", "/api/me/engagements/{engagementId}/conversations/scheduling-options", "Conversations", "List assigned people's scheduling options", "session"],
  ["post", "/api/me/engagements/{engagementId}/conversations/{eventTypeId}/attach", "Conversations", "Attach a workspace playbook to an engagement", "session"],
  ["get", "/api/me/engagements/{engagementId}/conversations/{eventTypeId}", "Conversations", "Get a conversation playbook", "session"],
  ["patch", "/api/me/engagements/{engagementId}/conversations/{eventTypeId}", "Conversations", "Update conversation metadata over an event type", "session"],
  ["get", "/api/me/bookings", "Organizer", "List organizer bookings", "session"],
  ["get", "/api/me/bookings.csv", "Organizer", "Export organizer bookings and custom answers", "session"],
  ...
  ["post", "/api/me/polls/{id}/invites", "Meeting polls", "Add poll invitees", "session"],
  ["delete", "/api/me/polls/{id}/invites/{inviteId}", "Meeting polls", "Remove a poll invitation", "session"],
  ["post", "/api/me/polls/{id}/invites/{inviteId}/resend", "Meeting polls", "Resend a poll invitation", "session"],
  ["post", "/api/me/polls/{id}/participants/{participantId}/resend", "Meeting polls", "Resend a poll finalization notice", "session"],
  ["get", "/api/me/signup-sheets", "Sign-up sheets", "List workspace sign-up sheets", "session"],
  ["post", "/api/me/signup-sheets", "Sign-up sheets", "Create a sign-up sheet", "session"],
  ["patch", "/api/me/signup-sheets/{id}", "Sign-up sheets", "Update enrollment and session capacity", "session"],
  ["get", "/api/me/signup-sheets/{id}/registrations.csv", "Sign-up sheets", "Export the enrollment roster", "session"],
  ["delete", "/api/me/signup-sheets/{id}/registrations/{registrationId}", "Sign-up sheets", "Cancel an enrollment", "session"],
  ["post", "/api/me/signup-sheets/{id}/registrations/{registrationId}/resend", "Sign-up sheets", "Resend an enrollment confirmation", "session"],
  ...
  ["put", "/api/me/event-type-folders/{id}", "Event types", "Rename or reposition an event type folder", "session"],
  ["delete", "/api/me/event-type-folders/{id}", "Event types", "Delete an event type folder", "session"],
  ["patch", "/api/me/event-types/{id}/folder", "Event types", "Move an event type into or out of a folder", "session"],
  ["get", "/api/me/booking-pages", "Booking pages", "List custom booking pages", "session"],
  ["post", "/api/me/booking-pages", "Booking pages", "Create a custom booking page", "session"],
  ["put", "/api/me/booking-pages/{id}", "Booking pages", "Replace a custom booking page", "session"],
  ["delete", "/api/me/booking-pages/{id}", "Booking pages", "Delete a custom booking page", "session"],
